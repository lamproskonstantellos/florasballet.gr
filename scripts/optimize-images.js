 ...
 *
 * Only the directories the <Picture> component reads from are processed
 * (images/, news/). The reference screenshots (_reference/) and the original
 * full-res masters (trash/) are listed in SKIP_DIRS so they can never be
 * processed or shipped even if SOURCE_DIRS is widened. Brand logos and
 * favicons are referenced directly as PNG and need no AVIF/WebP siblings.
 */
...
const SOURCE_DIRS = ["images", "news"];
const EXTENSIONS = [".jpg", ".jpeg", ".png"];
const SKIP_DIRS = new Set([
  "node_modules", "dist", ".git", "vendor", "scripts", "test", "build",
  "_reference", "trash", "palette", "brand", "favicon",
]);
