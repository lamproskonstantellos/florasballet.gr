...
(function () {
  // Social share targets for a canonical article URL. Facebook is the only
  // network with a public web share intent the school uses; Instagram has no
  // URL share API, so the row pairs this with copy-link / native share.
