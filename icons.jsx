...
/* ============================================================
   ...
   - Every icon is decorative: its control supplies the accessible
     name, so each <svg> defaults to aria-hidden="true"
     focusable="false" (a caller can override via props).
   ============================================================ */

const Icon = {
  arrowUR: (p) => (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...p}>
  ...
  check: (p) => (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...p}>
  ...
  menu: (p) => (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" {...p}>
  ...
  play: (p) => (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" fill="currentColor" {...p}>
  ...
  phone: (p) => (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" {...p}>
